...
best_settings = {
    ...
    "dca_amount_1": dca_amount_1,"dca_amount_2": dca_amount_2,"dca_amount_3": dca_amount_3,
    "dca_perc_1": dca_perc_1,"dca_perc_2": dca_perc_2,"dca_perc_3": dca_perc_3,
...
while 1:
    ...
    dca_amount_1 = best_settings['dca_amount_1']  
    dca_amount_2 = best_settings['dca_amount_2']  
    dca_amount_3 = best_settings['dca_amount_3']  
    dca_perc_1 = best_settings['dca_perc_1']  
    dca_perc_2 = best_settings['dca_perc_2']  
    dca_perc_3 = best_settings['dca_perc_3']  
    ...
    if startup==1:
        ...
        dca_amount_2 = 30
        dca_amount_3 = 55
        dca_perc_1 = round(random.uniform(max([dca_perc_1-0.02,0.01]), dca_perc_1+0.02),2)
        dca_perc_2 = round(random.uniform(max([dca_perc_2-0.02,0.01]), dca_perc_2+0.02),2)
        dca_perc_3 = round(random.uniform(max([dca_perc_3-0.02,0.01]), dca_perc_3+0.02),2)
        stop_loss = round(random.uniform(max([stop_loss-0.02,0.01]), stop_loss+0.02),2)
    ...
    if 0<recover_rate<best_recover_rate and min_trades_day<=trade_per_day:
        ...
        print("dca_amount_1 =",dca_amount_1,"\n"+"dca_amount_2 =",dca_amount_2,"\n"+"dca_amount_3 =",dca_amount_3)
        print("dca_perc_1 =",dca_perc_1,"\n"+"dca_perc_2 =",dca_perc_2,"\n"+"dca_perc_3 =",dca_perc_3)
