...
def define_messages(email,app_number,backtest_number):
    ...
    partial_error_message = {
        ...
        "content": {
            "title": "DCA entry partial entry error",
            "body": "App number: "+str(app_number)+" Backtest number: "+str(backtest_number)
        },
    }
